  ...
  `,
        ...
        if (activeSosResult.rows.length > 0) {
            ...
            return res.status(200).json({
                ...
                alreadyActive: true,
                message:
                    "We have already sent your location to your emergency contacts and nearest police station.",
                sos: activeSos,
                publicToken: activeSos.public_token,
                trackingLink: `${process.env.CLIENT_URL}/track/${activeSos.public_token}`,
            });
        }
        const {
            latitude,
